...
export const SectionItem: React.FC<SectionProps> = ({ section }) => {
  ...
  if (section.title === t("pedagogy.documents.title")) {
    return(
      ...
      <Link color="secondary">- Le règlement des études</Link>
      <Link color="secondary">- La déclaration des droits des étudiants et des étudiantes</Link>
      <Link color="secondary">- Règlements et documents officiels de la Faculté des Sciences et de Génie</Link>
      <Link color="secondary">- Règlements et documents officiels du département d’informatique et de génie logiciel</Link>
      <Link color="secondary">- Le bureau des droits étudiants</Link>
    </VStack>
    );
  }
  return (
