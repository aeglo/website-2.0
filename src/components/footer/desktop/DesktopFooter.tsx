        ...
        <Box bgColor="darkSection" color="darkSection" pl={"128px"} pr={"128px"} pt={"64px"} pb={"24px"} display={{ base: "none", md: "grid" }}>
            <Stack direction={"row"} justify={"space-between"}>
                ...
                <Stack justify={"end"} spacing={"16px"}>
                    <Text fontSize="20px" fontWeight="medium" color="white" align={"right"}>{t("footer.follow")}</Text>
                    <SocialMedias direction="row" color="white" />
                    <Stack justify={"right"} spacing={0} mt={"8px"}>
                        <Text fontSize="20px" fontWeight="medium" color="white" align={"right"}>{t("footer.madeBy")}:</Text>
                        <Link fontSize="20px" fontWeight="medium" color="secondary" textAlign={"right"} href="https://www.linkedin.com/in/laurent-aubin-84a907152/" isExternal>Laurent Aubin</Link>
                        <Link fontSize="20px" fontWeight="medium" color="secondary" textAlign={"right"} href="https://www.linkedin.com/in/cduchesne-1/" isExternal>Christophe Duchesne</Link>
                        <Link fontSize="20px" fontWeight="medium" color="secondary" textAlign={"right"} href="https://www.linkedin.com/in/fabienpoulin/" isExternal>Fabien Poulin</Link>
                    </Stack>
                </Stack>
            </Stack>
            <Text fontSize="16px" fontWeight="normal" color="white" align={"center"} mt={"81px"}>© Copyright 2021 AEGLO - {t("footer.copyright")}</Text>
        </Box>
    );
};